...
After all of the block fields have been initialized additional initialization can be performed on the block itself for loading or preparing additional data based on the fields.
