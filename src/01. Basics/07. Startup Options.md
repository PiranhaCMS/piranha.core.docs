...
Using the [options pattern](https://docs.microsoft.com/en-us/aspnet/core/fundamentals/configuration/options) in ASP.NET Core you can also easily configure you routing options in your `appsettings.json`. Please note that this is just an example and you settings could have any structure you wish.
